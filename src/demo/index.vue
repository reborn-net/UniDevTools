<template>
    ...
    >
      ...
      <template #action>
          ...
          <tm-button @click="goUrl('https://dev.api0.cn')" :round="24" color="red" label="在线文档" :font-size="24" :width="180" :height="64"></tm-button>
